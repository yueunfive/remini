...
// 둘러보기 - 카테고리별 회고 - FiveF
export const CategoryFiveF: React.FC = () => {
  ...
  const fetchCategoryRetroData = async () => {
    try {
      let url = `https://www.remini.store/api/remini/category?category=FIVE_F&pageNumber=${pageNumber}&pageSize=${pageSize}`;
      ...
      <CategoryBrowsingWrap>
        <nav>
          ...
          <div className="category_btn">
            ...
            <button className="active">5F</button>
