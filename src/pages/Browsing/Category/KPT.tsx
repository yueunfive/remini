...
// 둘러보기 - 카테고리별 회고 - KPT
export const CategoryKPT: React.FC = () => {
  ...
  const fetchCategoryRetroData = async () => {
    try {
      let url = `https://www.remini.store/api/remini/category?category=KPT&pageNumber=${pageNumber}&pageSize=${pageSize}`;
      ...
      <CategoryBrowsingWrap>
        <nav>
          ...
          <div className="category_btn">
            <button className="active">KPT</button>
