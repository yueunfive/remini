...
// 둘러보기 - 카테고리별 회고 - YWT
export const CategoryYWT: React.FC = () => {
  ...
  const fetchCategoryRetroData = async () => {
    try {
      let url = `https://www.remini.store/api/remini/category?category=YWT&pageNumber=${pageNumber}&pageSize=${pageSize}`;
      ...
      <CategoryBrowsingWrap>
        <nav>
          ...
          <div className="category_btn">
            ...
            <button className="active">YWT</button>
