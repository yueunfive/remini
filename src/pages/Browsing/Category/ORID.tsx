...
// 둘러보기 - 카테고리별 회고 - ORID
export const CategoryORID: React.FC = () => {
  ...
  const fetchCategoryRetroData = async () => {
    try {
      let url = `https://www.remini.store/api/remini/category?category=ORID&pageNumber=${pageNumber}&pageSize=${pageSize}`;
      ...
      <CategoryBrowsingWrap>
        <nav>
          ...
          <div className="category_btn">
            ...
            <button className="active">ORID</button>
