...
// 둘러보기 - 카테고리별 회고 - AAR
export const CategoryAAR: React.FC = () => {
  ...
  const fetchCategoryRetroData = async () => {
    try {
      let url = `https://www.remini.store/api/remini/category?category=AAR&pageNumber=${pageNumber}&pageSize=${pageSize}`;
      ...
      <BrowsingWrap>
        <nav>
          ...
          <div className="category_btn">
            ...
            <button className="active">AAR</button>
