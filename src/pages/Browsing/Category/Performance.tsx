...
export const CategoryPerformance: React.FC = () => {
  ...
  const fetchCategoryRetroData = async () => {
    try {
      let url = `https://www.remini.store/api/remini/category?category=RESULT&pageNumber=${pageNumber}&pageSize=${pageSize}`;
      ...
      <CategoryBrowsingWrap>
        <nav>
          ...
          <div className="category_btn">
            ...
            <button className="active">성과/수치 중심 회고</button>
          </div>
        </nav>
